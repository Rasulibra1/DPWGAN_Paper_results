...
HOLDOUT_CSV = ROOT / "data" / "cancer_holdout_final.csv"

EVAL_DIR    = ROOT / "eval" / "metrics_raw" / "cancer" / "dpwgan"
...
def main():
    ...
    raw_csv = EVAL_DIR / "final_cancer_dpwgan_raw_full_eval_all_eps_seeds_present.csv"
    ...
    combined_csv = EVAL_DIR / "final_cancer_dpwgan_metrics_all_eps_seeds_10_31.csv"
    ...
    summary_csv = SUMMARY_DIR / "final_cancer_dpwgan_metrics_summary_by_epsilon.csv"
