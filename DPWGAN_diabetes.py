...
SAVE_SYNTH = True
SYNTH_DIR  = ROOT / "data" / "synth" / "diabetes" / "dpwgan"  # pick whatever path you like


# You said train/holdout are in a folder called "data"
# Adjust filenames if yours differ.
REAL_CSV    = ROOT / "data" / "diabetes_train_final.csv"
HOLDOUT_CSV = ROOT / "data" / "diabetes_holdout_final.csv"

EVAL_DIR    = ROOT / "eval" / "metrics_raw" / "diabetes" / "dpwgan"
...
def main():
    ...
    raw_csv = EVAL_DIR / "final_diabetes_dpwgan_raw_full_eval_all_eps_seeds_present.csv"
    ...
    for epsilon in EPS_LIST:
        ...
        for seed in SEED_RANGE:
            ...
            if SAVE_SYNTH:
                ...
                synth_path = SYNTH_DIR / f"diabetes_dpwgan_eps_{int(epsilon)}_seed_{int(seed)}.csv"
    ...
    combined_csv = EVAL_DIR / "final_diabetes_dpwgan_metrics_all_eps_seeds_10_31.csv"
    ...
    summary_csv = SUMMARY_DIR / "final_diabetes_dpwgan_metrics_summary_by_epsilon.csv"
